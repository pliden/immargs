...
//! # Basic Example
//!
//! This exanple is using [`args_from_env!`] for on-the-spot declaration and parsing of
...
//! ```
//!
//! [`args_from_env!`] returns a `struct` with fields derived from to the arguments
...
//! # Advanced Example
//!
//! This example is using [`args!`] to declare command line arguments. The main program
//! takes a command as its last argument, and each (sub)command use [`args!`] do declare
...
//!
//! [examples]: https://github.com/pliden/immargs/tree/main/examples
//!
//! # Terminology
//!
...
//! #### Field Names
//!
//! The field names of the `struct` generated by [`args!`] are derived as follows.
//!
...
//! #### Field Types
//!
//! The field types of the `struct` generated by [`args!`] are derived as follows.
//!
...
//! #### Methods
//!
//! The following methods are available on `struct`s generated by [`args!`].
//!
//! | Method | Return Type |
//! | - | - |
//! | `from_env()` | `Self` |
...
//! _conflict-id_ is an identifier used if there are more than one group of conflicting
...
//! in the arguments `struct` generated by [`args!`]. When parsing the command line using
...
/// A trait implemented by all arguments `struct`s generated by [`args!`].
///
